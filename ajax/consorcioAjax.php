...
switch ($_GET["op"]){
    ...
    case 'listar':
        ...
        while ($reg=$rspta->fetch_object()){ //mientras haya algo en respuesta
    ...
    case 'guardar':
            ...
            $rspta=$consorcio->insertar($nombre,  $direccion, $localidad,$cod_postal, $telefono, $email, $encargado, $latitud, $longitud);
