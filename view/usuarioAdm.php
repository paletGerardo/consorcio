                            ...
                            <form name="formulario" id="formulario" method="POST">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                   ...
                                   <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="fecha" id="fecha" maxlength="100" placeholder="fecha nacimiento" required>
                                </div>
...
?>
        <script type="text/javascript" src="scripts/usuarioAdm.js"></script>
