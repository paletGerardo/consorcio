                                ...
                                <form name="formulario" id="formulario" method="POST">
                                    ...
                                    <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" name="localidad"
                                               id="localidad" maxlength="20" placeholder="Localidad" required>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                     ...
                                     <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" name="latitud" id="latitud"
                                               maxlength="20" placeholder="Latitud">
                                    </div>
                                     <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <label>Longitud:</label>
                                        <input type="text" class="form-control" name="longitud" id="longitud"
                                               maxlength="20" placeholder="Longitud">
                                    </div>
...
?>
<script type="text/javascript" src="scripts/consorcioAdm.js"></script>
